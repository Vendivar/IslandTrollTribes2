...
function MakeBoulder( event )
	...
	local particleName = "particles/custom/spirit_boulder.vpcf"
    ...
    Timers:CreateTimer(1.0,
		function() 
			...
			-- Spawn as many treants as possible
				local boulder = CreateUnitByName("npc_spirit_boulder", point, false, caster, caster, caster:GetTeamNumber())
