...
function ITT:OnSubclassChange(event)
    ...
    if hero.subclassAvailableParticle then
        ...
        ParticleManager:SetParticleControl( subParticle, 0, target:GetAbsOrigin() )
        ParticleManager:SetParticleControl( subParticle, 1, target:GetAbsOrigin() )
        ParticleManager:SetParticleControl( subParticle, 2, target:GetAbsOrigin() )
        ParticleManager:SetParticleControl( subParticle, 3, target:GetAbsOrigin() )
