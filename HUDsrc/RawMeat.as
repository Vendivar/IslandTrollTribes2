package  {
	...
	public class RawMeat extends MovieClip
	{
		...
		public function RawMeat() { 
			this.button_drop_raw_meat.addEventListener(MouseEvent.CLICK, onButtonDropRawMeatClicked);
			this.button_eat_raw_meat.addEventListener(MouseEvent.CLICK, onButtonEatRawMeatClicked);
		}
